...
// Square root: 1.73205
//
// Let x be the number entered by the user. Newton's method requires an itial
...
// rather than float.
//
// Have the program terminate when the absolute value of the
...
// value of a double. (You'll need to include the <math.h> header at the begging
// of your program in order to use fabs.) Solution
#include <math.h>
#include <stdio.h>
