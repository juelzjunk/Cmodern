...
// can be computed using only two multiplications instaed of three.
//
// As it happens, this technique can be used even when n is not a power of 2.
//
...
//
// To test your functuion, write a program that asks the user to enter
// values for x and n, calls power to compute x^n, and then displays the
